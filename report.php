    ...
    <div class="flex flex-col md:col-start-2 md:col-span-3">
        <div class="bg-white shadow-md rounded-3xl p-5  max-h-full overflow-auto">
            <div class="flex flex-col sm:flex-row items-center">
                <h2 class="font-semibold text-lg mr-auto">Report Incident</h2>
                <div class="w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0"></div>
            </div>
            <div class="mt-5">
                <form action="controller/controller.php" method="post" enctype="multipart/form-data">
                    <div class="form">
                        <div class="md:flex flex-row flex-wrap justify-center md:space-x-4 w-full text-xs">
                            ...
                            <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                ...
                                <textarea required="" name="notes" id="" class="w-full min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Describe the situatuion" spellcheck="false"></textarea>
                            
                            </div>
                            <p class="text-xs text-red-500 text-right my-3">Required fields are marked with an
                                asterisk <abbr title="Required field">*</abbr></p>
                            <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                <button type="submit" name="report" id="report" class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500">Report</button>
                            </div>
                        </div>
                    </div>
                </form>
