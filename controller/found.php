...
if(isset($_POST['postlost']))
{
    ...
    $errors=[];
    $target_dir = getcwd()."/../uploads/found/$id/";
    ...
    // if everything is ok, try to upload file
        ...
        // $notes=$_POST['notes'];
        $db->insert('pictures',['ref_id'=>$id,'name'=>$_FILES["files"]["name"],'type'=>'found']);
        $_SESSION['msg']=['type'=>'success','msg'=>"Post for Found Successful, waiting for approval"] ;
        header('location:../found.php');
        return;
        } else {
